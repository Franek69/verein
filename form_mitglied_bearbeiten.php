...
#in prepare darf man noch keine expliziten Werte angeben, deswegen = ?
...
<html lang="de" dir="ltr">
  ...
  <body>
    ...
    <form action="mitglied_bearbeiten.php" method="post">
      ...
      <p>Vorname*<br>
        <input type="text" name="vorname" value="<?php echo $mitglied[0]["vorname"] ?>"  placeholder="Vorname" required>
      </p>
      <p>Nachname*<br>
        <input type="text" name="name" value="<?php echo $mitglied[0]["name"] ?>" placeholder="Nachname" required>

      </p>
      <p>Geschlecht<br>
        <input type="text" name="geschlecht" value="<?php echo $mitglied[0]["geschlecht"] ?>" placeholder="Geschlecht">
      </p>
